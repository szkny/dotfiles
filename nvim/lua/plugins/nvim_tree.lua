return {
	...
	config = function(_, opts)
		...
		vim.api.nvim_set_hl(0, "NvimTreeModifiedIcon", { fg = "#ffddaa", bg = "none", bold = true })
		vim.api.nvim_set_hl(0, "NvimTreeModifiedFileHL", { fg = "#ffddaa", bg = "none", bold = true })
		vim.api.nvim_set_hl(0, "NvimTreeModifiedFolderHL", { fg = "#ffddaa", bg = "none", bold = true })
