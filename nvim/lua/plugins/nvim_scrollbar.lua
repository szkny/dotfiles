return {
  ...
  config = function(_, opts)
    ...
    vim.api.nvim_set_hl(0, "ScrollbarError", { fg = DgsErrorHl.fg, bg = "none", bold = true })
    vim.api.nvim_set_hl(0, "ScrollbarErrorHandle", { fg = DgsErrorHl.fg, bg = "#555555", bold = true })
    vim.api.nvim_set_hl(0, "ScrollbarWarn", { fg = DgsWarnHl.fg, bg = "none", bold = true })
    vim.api.nvim_set_hl(0, "ScrollbarWarnHandle", { fg = DgsWarnHl.fg, bg = "#555555", bold = true })
    vim.api.nvim_set_hl(0, "ScrollbarHint", { fg = DgsHintHl.fg, bg = "none", bold = true })
    vim.api.nvim_set_hl(0, "ScrollbarHintHandle", { fg = DgsHintHl.fg, bg = "#555555", bold = true })
